...
describe.skip('Pagination', () => {
  ...
  describe('with default props as total pages 4 and current page 1', () => {
    let wrapper;
    const options = { limit: 5, page: 1, totalPages: 4, fetch: false };
    ...
    it('should disable the prev button and enable the next button if page is 1', () => {
      ...
      expect(wrapper.find('#next').prop('disabled')).toBeFalsy();
    });
  ...
  describe('with props as total pages 1 and current page 1', () => {
    ...
    it('should render properly', () => {
      expect(wrapper1.find('#prev').prop('disabled')).toBeTruthy();
      expect(wrapper1.find('#next').prop('disabled')).toBeTruthy();
    });
